            ...
            with self.subTest(stream=stream):
                ...
                self.assertEqual(
                    ...
                    msg="expected replication key {} but actual is {}".format(
                        ...
                        set(
                            stream_properties[0]
                            .get("metadata", {self.REPLICATION_KEYS: None})
                            .get(self.REPLICATION_KEYS, [])
                        ),
                    ),
                )
                ...
                self.assertEqual(
                    ...
                    msg="expected primary key {} but actual is {}".format(
                        ...
                        set(
                            stream_properties[0]
                            .get("metadata", {self.PRIMARY_KEYS: None})
                            .get(self.PRIMARY_KEYS, [])
                        ),
                    ),
                )
                ...
                expected_replication_keys = self.expected_replication_key_metadata()[
                    stream
                ]
