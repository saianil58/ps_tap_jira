...
class TestFlattenStreams(unittest.TestCase):
    ...
    not_nested = {"worklogs": streams.STREAMS["worklogs"]}
...
class TestRaiseIfBookmarkCannotAdvance(unittest.TestCase):
    dummy_worklog = {"updated": "2020-07-24T06:28:45.782+0000"}

    def test_raise_exception(self):
        thousand_worklogs = [self.dummy_worklog for _ in range(1000)]
        self.assertRaises(
            Exception, utils.raise_if_bookmark_cannot_advance, thousand_worklogs
        )
